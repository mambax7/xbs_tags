...
/** @var Xbstags\Common\Configurator $configurator */
$configurator = new Xbstags\Common\Configurator();

/** @var \XoopsModules\Xbstags\Common\Migrate $migrator */
$migrator = new \XoopsModules\Xbstags\Common\Migrate($configurator);
